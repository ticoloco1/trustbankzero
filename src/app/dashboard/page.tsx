...
import DashboardSlugs from '@/components/dashboard/DashboardSlugs';
...
const Dashboard = () => {
  ...
  if (!user) return <>{typeof window !== "undefined" && (window.location.href="/auth")}</>;

  return (
    <div className="min-h-screen bg-background">
      <SEOHead title="Dashboard – TrustBank" description="View your earnings, holdings and wallet balance on TrustBank." path="/dashboard" noIndex />
      <Header />
