...
const AdminSlugListings = lazy(() => import("@/components/admin/AdminSlugListings"));
const AdminCompanySlugs = lazy(() => import("@/components/admin/AdminCompanySlugs"));
...
import {
  ...
  Zap, Trophy, Wallet, Flame, Brain, Power, Megaphone as MegaphoneIcon, Image, Key, Building2
} from "lucide-react";
...
return null;  }
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead title="Admin – TrustBank" description="Platform administration panel for TrustBank." path="/governance" noIndex />
      <Header />
        ...
        <Tabs defaultValue="analytics" className="space-y-4">
          <TabsList className="bg-secondary flex-wrap">
            ...
            <TabsTrigger value="premiumslugs">
              <Flame className="w-3.5 h-3.5 mr-1" />Slugs Premium
            </TabsTrigger>
            <TabsTrigger value="sluglistings">
              <Grid3X3 className="w-3.5 h-3.5 mr-1" />Slug Sales
            </TabsTrigger>
            <TabsTrigger value="domains">
              <Globe className="w-3.5 h-3.5 mr-1" />Domains
            </TabsTrigger>
            <TabsTrigger value="companyslugs">
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                  <SettingsCard icon={<DollarSign className="w-4 h-4 text-primary" />} title="Hosting Fees (Annual)">
                    ...
                    <SettingsInput label="Upload TrustBank ($)" defaultValue={settings.listing_fee_gateway} onSave={(v) => updateSettings.mutate({ listing_fee_gateway: v })} />
          ...
          {/* ─── SLUG LISTINGS / SALES TAB ─── */}
          <TabsContent value="sluglistings">
            <Suspense fallback={<div className="text-center py-10 text-muted-foreground text-sm">Loading...</div>}>
              <AdminSlugListings />
            </Suspense>
          </TabsContent>
          ...
          {/* ─── COMPANY SLUGS TAB ─── */}
          <TabsContent value="companyslugs">
            <Suspense fallback={<div className="text-center py-10 text-muted-foreground text-sm">Loading...</div>}>
              <AdminCompanySlugs />
            </Suspense>
          </TabsContent>
