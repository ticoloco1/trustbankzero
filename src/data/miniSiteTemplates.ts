...
export const MINI_SITE_TEMPLATES: MiniSiteTemplate[] = [
  ...
  // ─── Real Estate (6) ───
  t("realestate-broker",     "RE Broker",             "Real Estate","midnight", 2, true,  ["bio","cv","videos","links","feed"],      "card",     "#0ea5e9", "#0c4a6e", "Broker profile with listings & CV"),
  t("realestate-agency",     "RE Agency",             "Real Estate","ocean",    3, false, ["bio","videos","links","feed"],           "bold",     "#06b6d4", "#083344", "Agency showcase with property grid"),
  t("realestate-luxury",     "RE Luxury",             "Real Estate","midnight", 2, false, ["bio","videos","links"],                  "glass",    "#d4af37", "#1c1917", "Luxury properties with gold accents"),
  t("realestate-commercial",  "RE Commercial",        "Real Estate","midnight", 3, true,  ["bio","cv","videos","links","feed"],      "magazine", "#475569", "#0f172a", "Commercial real estate magazine"),
  t("realestate-portfolio",  "RE Portfolio",          "Real Estate","sunset",   3, true,  ["bio","cv","videos","links"],             "card",     "#f59e0b", "#451a03", "Property portfolio with warm tones"),
  t("realestate-minimal",    "RE Minimal",            "Real Estate","white",    1, true,  ["bio","cv","videos","links","feed"],      "minimal",  "#2563eb", "#ffffff", "Clean minimal broker page"),
];
