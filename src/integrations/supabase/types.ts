  ...
  public: {
    Tables: {
      ...
      company_slug_bids: {
        ...
        Relationships: [
          {
            foreignKeyName: "company_slug_bids_company_slug_id_fkey"
            columns: ["company_slug_id"]
            isOneToOne: false
            referencedRelation: "company_slugs"
            referencedColumns: ["id"]
          },
        ]
      }
      ...
      domain_offers: {
        ...
        Relationships: [
          {
            foreignKeyName: "domain_offers_listing_id_fkey"
            columns: ["listing_id"]
            isOneToOne: false
            referencedRelation: "domain_listings"
            referencedColumns: ["id"]
      ...
      mini_sites: {
        Row: {
          ...
          slug: string
          slug_expires_at: string | null
          slug_registration_id: string | null
        ...
        Relationships: [
          {
            foreignKeyName: "mini_sites_slug_registration_id_fkey"
            columns: ["slug_registration_id"]
            isOneToOne: false
            referencedRelation: "slug_registrations"
            referencedColumns: ["id"]
          },
        ]
      }
      ...
      platform_settings: {
        Row: {
          ...
          minisite_monthly_price: number
          minisite_pro_price: number
          minisite_subdomain_1char: number
          minisite_subdomain_2char: number
          minisite_subdomain_3char: number
          minisite_subdomain_4char: number
      ...
      slug_auctions: {
        ...
        Relationships: [
          {
            foreignKeyName: "slug_auctions_slug_id_fkey"
            columns: ["slug_id"]
            isOneToOne: false
            referencedRelation: "premium_slugs"
            referencedColumns: ["id"]
          },
        ]
      }
      ...
      slug_registrations: {
        ...
        Relationships: [
          {
            foreignKeyName: "slug_registrations_site_id_fkey"
            columns: ["site_id"]
            isOneToOne: false
            referencedRelation: "mini_sites"
            referencedColumns: ["id"]
