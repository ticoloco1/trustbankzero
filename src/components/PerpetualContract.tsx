    ...
    <div className="bg-card border border-border rounded-lg p-4 space-y-4">
        ...
        <div className="space-y-1.5">
          ...
          <div className="flex items-center justify-between bg-secondary/50 rounded px-3 py-2">
            <div className="flex items-center gap-2">
              ...
              <span className="text-[10px] font-bold text-card-foreground">Platform Reserve (TrustBank)</span>
            </div>
            <div className="text-right">
      ...
      <div className="border-t border-border pt-3">
        ...
        <p className="text-[9px] text-muted-foreground leading-relaxed">
          Upon annual fee default (pre-issuance only), the perpetual license rights are transferred to TrustBank.
