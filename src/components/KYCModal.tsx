      ...
      <div className="bg-card border border-border rounded-lg w-full max-w-md p-6 space-y-4 relative">
        ...
        <div className="space-y-3 text-xs text-muted-foreground">
          ...
          <ul className="list-disc pl-4 space-y-1">
            ...
            <li>You acknowledge TrustBank is a tech platform, not a financial advisor</li>
          </ul>
        </div>
        ...
        <p className="text-[7px] text-muted-foreground/60 text-center">
          TRUSTBANK IS A TECH PLATFORM. HIGH RISK ASSET. TRADING INVOLVES RISK OF TOTAL LOSS.
        </p>
      </div>
    </div>
  );
