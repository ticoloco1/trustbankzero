...
const tiers = [
  { letters: "1 letter", example: "trustbank.xyz/s/a", price: "$2,000", icon: Crown, highlight: true },
  { letters: "2 letters", example: "trustbank.xyz/s/ab", price: "$1,500", icon: Star, highlight: false },
  { letters: "3 letters", example: "trustbank.xyz/s/abc", price: "$1,000", icon: Sparkles, highlight: false },
  { letters: "4 letters", example: "trustbank.xyz/s/abcd", price: "$500", icon: Globe, highlight: false },
];
