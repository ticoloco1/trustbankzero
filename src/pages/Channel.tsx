...
const Channel = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead title="My Channel – TrustBank" description="Manage your videos and shares on TrustBank." path="/channel" noIndex />
      <Header />
            ...
            <AlertDialogDescription asChild>
              <div className="space-y-3 text-sm">
                ...
                <div className="bg-secondary rounded-lg p-3 space-y-1 text-xs">
                  ...
                  <p>• <strong>Platform Reserve (TrustBank):</strong> 50 shares (5%) — permanent</p>
                </div>
