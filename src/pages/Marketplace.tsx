...
const Marketplace = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead title="NFT Marketplace – TrustBank" description="Browse, buy and sell video NFTs on TrustBank Marketplace. Discover exclusive creator content and trade digital collectibles." path="/marketplace" />
      <Header />
