...
const ExchangeIndex = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead title="HPI Index – TrustBank Exchange" description="Track the TrustBank HPI index – a composite of top-performing video assets weighted by market cap, volume, and engagement." path="/exchange/index" />
      <Header />
      ...
      <div className="max-w-7xl mx-auto px-6 py-6 space-y-6">
        ...
        <div className="bg-card border border-border rounded-lg p-6">
          <div className="flex flex-col md:flex-row md:items-end gap-4 mb-4">
            <div>
              <p className="text-xs text-muted-foreground font-mono uppercase">TrustBank Index</p>
