...
const ExchangeFutures = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead title="Futures Trading – TrustBank Exchange" description="Trade video futures contracts with leverage on TrustBank. Long or short creator assets with real-time order books." path="/exchange/futures" />
      <Header />
