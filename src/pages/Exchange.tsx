...
const Exchange = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead title="TrustBank Exchange – Trade Video Shares" description="Buy and sell video shares on TrustBank Exchange. Track top gainers, losers, and futures contracts in real-time." path="/exchange" />
      <Header />
        ...
        <div className="bg-card border border-border rounded-lg p-4">
          <div className="flex items-center justify-between mb-3">
            <h2 className="text-sm font-bold text-foreground uppercase flex items-center gap-2">
              <Activity className="w-4 h-4 text-primary" /> TrustBank Index (HPI)
            </h2>
