...
const CreatorProfile = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead title={`${profile.display_name || "Creator"} – TrustBank`} description={`Explore videos and assets by ${profile.display_name || "this creator"} on TrustBank.`} path={`/creator/${id}`} />
      <Header />
